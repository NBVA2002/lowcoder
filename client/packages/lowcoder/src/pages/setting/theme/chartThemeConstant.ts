...
export const ChartYellowTheme = {
  color: ["#f2cb55", "#d95850", "#eb8146", "#ffb248", "#f2d643", "#ebdba4"],
  backgroundColor: "#495780",
  textStyle: {},
  title: { textStyle: { color: "#ffffff" }, subtextStyle: { color: "#ffffff" } },
  line: {
  ...
  boxplot: { itemStyle: { borderWidth: 0, borderColor: "#cccccc" } },
  ...
  map: {
    itemStyle: { areaColor: "#f3f3f3", borderColor: "#999999", borderWidth: 0.5 },
    label: { color: "#893448" },
    emphasis: {
      itemStyle: { areaColor: "#ffb248", borderColor: "#eb8146", borderWidth: 1 },
      label: { color: "#893448" },
    },
  },
  geo: {
  ...
  toolbox: {
    ...
    emphasis: { iconStyle: { borderColor: "#666666" } },
  },
  ...
  timeline: {
    lineStyle: { color: "#893448", width: 1 },
    itemStyle: { color: "#893448", borderWidth: 1 },
    controlStyle: { color: "#893448", borderColor: "#893448", borderWidth: 0.5 },
    checkpointStyle: { color: "#eb8146", borderColor: "#ffb248" },
    label: { color: "#893448" },
    emphasis: {
  ...
  visualMap: { color: ["#893448", "#d95850", "#eb8146", "#ffb248", "#f2d643", "rgb(247,238,173)"] },
  dataZoom: {
...
export const ChartGreenTheme = {
  ...
  map: {
    ...
    label: { color: "#28544e" },
    emphasis: {
      itemStyle: { areaColor: "rgba(34,195,170,0.25)", borderColor: "#22c3aa", borderWidth: 1 },
      label: { color: "#349e8e" },
    },
  },
  geo: {
  ...
  timeline: {
    lineStyle: { color: "#4ea397", width: 1 },
    itemStyle: { color: "#4ea397", borderWidth: 1 },
    controlStyle: { color: "#4ea397", borderColor: "#4ea397", borderWidth: 0.5 },
    checkpointStyle: { color: "#4ea397", borderColor: "#3cebd2" },
    label: { color: "#4ea397" },
    emphasis: {
  ...
  visualMap: { color: ["#d0648a", "#22c3aa", "#adfff1"] },
  dataZoom: {
    backgroundColor: "rgba(255,255,255,0)",
